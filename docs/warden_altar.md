...
- **Floor** (`y-1`): 5x5 Reinforced Sculk Froglight, with the **Echoing
  Catalyst** capstone set into the floor one block beyond the pit center,
  away from the Hatch (crafted from a Sculk Catalyst - building the altar
  proves a first Warden kill; the altar pays catalysts thereafter).

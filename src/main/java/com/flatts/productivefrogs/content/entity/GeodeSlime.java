 ...
 * colour ({@link #getParticleType} returns a GEODE-tinted dust particle in
 ...
 * discovery path. GeodeSlime covers GEODE; Tide/Void cover TIDE/VOID in
 * subsequent PRs.
 *
...
public class GeodeSlime extends Slime {
    ...
    protected ParticleOptions getParticleType() {
        return Category.GEODE.tintParticle();
    }
}

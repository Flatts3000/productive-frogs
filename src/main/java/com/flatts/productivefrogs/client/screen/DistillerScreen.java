...
/**
 * Client screen for the Distiller (#253): a vertical RF energy bar (left), the
 * distill-progress arrow (centre, input -> output), and the input/output slots.
 * Reuses the Casting Mold GUI sheet as placeholder art until the lane's own
 * art pass; the energy bar is drawn as a flat fill over the gauge frame.
 *
 * <p>Energy + progress ride the menu's synced {@code ContainerData}.
 */

...
- **In-game guide: none in 2.0.** Patchouli has no 26.1 build and the 1.x guide content was not ported; the guidebook rewrite is deferred (engine survey done - Modonomicon is the leading candidate).
